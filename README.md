...
# Contribution [#1]: [[React Doctor] no-generic-handler-names: Non-descriptive handler name "handleChange" — name should describe what it do... (11 occurrences)]
...
The reason why this issue intrested me was because the work behind it was more frontend heavy rather then backend.
